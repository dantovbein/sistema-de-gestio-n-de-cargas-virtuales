<?php
	...
	$txt .= "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------";
	$txt .= "\n";
	$txt .= "Fecha   |   ID Cliente   |   Cliente   |   Subtotal telefonía   |   Comision telefonía   |   Cant. tiradas   |   Importe total tiradas   |   Importe total telefonía   |   Subtotal Tv prepaga   |   Comision Tv prepaga   |   Total Tv prepaga   |   Total a cobrar";
	$txt .= "\n";
	$txt .= "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------";
	$txt .= "\n";
	$txt .= "\n";
